...
const PreviousPregnancySchema = z.object({
  ...
  pastPregnancyComplications: z.string().nullable(),
...
export {
  createPreviousPregnancyHandler,
  getPreviousPregnancyHandler,
  updatePreviousPregnancyHandler,
  deletePreviousPregnancyHandler,
};
